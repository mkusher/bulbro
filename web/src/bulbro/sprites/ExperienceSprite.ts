...
export class ExperienceSprite {
	...
	constructor(
		...
		const blackBorderRectangle =
			new PIXI.Graphics();
		blackBorderRectangle.beginFill(
			0x000000,
		);
		const blackBorderRectangleWidth =
		...
		this.#materialsText.y =
			blackBorderRectangle.y +
			blackBorderRectangle.height +
			padding;
		this.#materialsText.x =
			leftBorder +
			padding;

		const greenExperienceRectangle =
			new PIXI.Graphics();
		blackBorderRectangle.addChild(
			greenExperienceRectangle,
		);
		blackBorderRectangle.addChild(
			this
				.#lvlText,
		);
		this.#blackBorderRectangle =
			blackBorderRectangle;
		this.#greenExperienceRectangle =
			greenExperienceRectangle;
		this.#gfx.addChild(
			this
				.#blackBorderRectangle,
	...
	update(
		...
		greenExperienceRectangle.beginFill(
			0x22cc22,
		);
		const padding = 5;
