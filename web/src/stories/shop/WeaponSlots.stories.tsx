...
export default {
	title: "Shop/WeaponSlots",
	component: WeaponSlots,
};

// Default with 3 weapons
export const ThreeWeapons = {
	render: (args: any) => <WeaponSlots {...args} />,
	args: {
		weapons: [pistol, sword, fist],
		maxSlots: 6,
		onWeaponClick: (weapon: Weapon, index: number) => {
			console.log("Clicked weapon:", weapon.name, "at slot", index);
		},
	},
};
...
export const FullSlots = {
	render: (args: any) => <WeaponSlots {...args} />,
	args: {
		weapons: [pistol, sword, fist, smg, ak47, doubleBarrelShotgun],
		maxSlots: 6,
		onWeaponClick: (weapon: Weapon, index: number) => {
			console.log("Clicked weapon:", weapon.name, "at slot", index);
		},
...
export const AlmostFull = {
	render: (args: any) => <WeaponSlots {...args} />,
	args: {
		weapons: [pistol, sword, fist, smg, ak47],
		maxSlots: 6,
		onWeaponClick: (weapon: Weapon, index: number) => {
			console.log("Clicked weapon:", weapon.name, "at slot", index);
		},
